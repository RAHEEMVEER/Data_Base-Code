    ...
    while (continueProram) {
        ...
        if (choice.choice === "ADD DATA:") {
            ...
            if (userInput.cnic) {
                ...
                console.log(chalk.blueBright.italic.bold(`\t\t    YOUR NAME IS: `) +
                ...
                console.log(chalk.yellow.italic.bold(`\t\t     YOUR DATA IS SAVED IN OUR PROGRAM.\n\t\t PLEASE CHECK IT OUT FROM SEARCH DATA OPTION.`));
                console.log(chalk.green.bold.italic(`\t\t============================================\n`));
            }
            else {
            ...
            console.log(chalk.yellow.italic.bold(`\t\t    THANKS FOR USING OUR PROGRAM. WE WISH YOU A HAPPY DAY.
